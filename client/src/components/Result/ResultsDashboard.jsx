      ...
      <div className="relative z-10 flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {hardwareComponents.map((comp) => {
            ...
            let cardClasses =
              "relative flex flex-col p-6 rounded-2xl bg-white/[0.03] backdrop-blur-2xl border border-white/10 shadow-2xl transition-all duration-300 ease-out hover:-translate-y-1 group ";
            if (isBottleneck)
              cardClasses +=
                ...
                {editingPart === comp.id ? (
                  ...
                  <div className="flex flex-col gap-3 mt-auto bg-black/20 p-4 rounded-xl border border-white/5 shadow-inner">
                    <div className="group/tooltip relative flex flex-col border-b border-white/5 pb-2 min-w-0">
                      ...
                      {/* Custom Tooltip for Your PC */}
                      <div className="absolute bottom-full left-0 mb-1 opacity-0 group-hover/tooltip:opacity-100 pointer-events-none transition-opacity duration-200 z-50 bg-[#1a1b1e] border border-cyan-500/30 text-[#e8eaed] text-xs px-3 py-2 rounded-lg shadow-xl w-max max-w-[250px] whitespace-normal">
                        {comp.userSpec || "N/A"}
                      </div>
                    </div>
                    <div className="group/tooltip relative flex flex-col min-w-0">
                      ...
                      {/* Custom Tooltip for Recommended */}
                      <div className="absolute bottom-full left-0 mb-1 opacity-0 group-hover/tooltip:opacity-100 pointer-events-none transition-opacity duration-200 z-50 bg-[#1a1b1e] border border-emerald-500/30 text-[#e8eaed] text-xs px-3 py-2 rounded-lg shadow-xl w-max max-w-[250px] whitespace-normal">
                        {comp.reqSpec || "N/A"}
                      </div>
                    </div>
                  </div>
              ...
              <div className="relative flex flex-col items-center">
                <div className="relative w-48 h-48 flex items-center justify-center mt-2">
                  ...
                  <div className="text-center z-20 flex flex-col items-center px-2">
                    <span
                      className={`${scoreText.length >= 4 ? "text-3xl" : "text-4xl"} font-black drop-shadow-md tracking-tight transition-all duration-300`}
