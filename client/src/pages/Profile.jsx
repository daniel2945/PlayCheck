...
export default function Profile() {
  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      <div className="relative z-10 px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto space-y-8 min-h-screen w-full">
        ...
        <div className="bg-[#303134]/90 backdrop-blur-sm border border-[#5f6368] rounded-xl p-5 sm:p-6 shadow-lg">
          ...
          {specs ? (
            ...
            <div className="flex flex-col items-start gap-4">
              ...
              <Link
                to="/setup"
                className="bg-[#8ab4f8] text-[#202124] px-6 py-2 rounded-full font-bold hover:bg-[#aecbfa] transition-colors shadow-md"
              >
                Set Up My PC
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          {/* Recommended Games */}
          <div className="bg-[#303134]/90 backdrop-blur-sm border border-[#5f6368] rounded-xl p-6 shadow-lg min-h-[250px] flex flex-col">
