          ...
          <div className="flex-grow">
            {loadingRecs ? (
                ...
                {recommendations.map((game, index) => (
                  ...
                  >
                    {game.image ? (
                      ...
                      <div className="w-16 h-10 bg-[#303134] rounded flex items-center justify-center text-[#5f6368] text-xs">No img</div>
                    )}
                    <div className="flex-1 overflow-hidden">
                      <p className="text-[#e8eaed] font-medium truncate text-sm">{game.title}</p>
                      {game.metacritic && (
              ...
              <div className="flex flex-col items-center justify-center h-full text-center mt-6">
                <svg className="w-12 h-12 text-[#5f6368] mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <p className="text-[#9aa0a6] text-sm">No specific recommendations yet.</p>
                <p className="text-[#9aa0a6] text-xs mt-1">Make sure your PC specs are up to date.</p>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="flex-grow">
            {loadingHistory ? (
              ...
              <div className="space-y-3">
                {searchHistory.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 overflow-hidden">
                      <p className="text-[#e8eaed] font-medium truncate text-sm">{item.title}</p>
              ...
              <div className="flex flex-col items-center justify-center h-full text-center mt-6">
                ...
                <p className="text-[#9aa0a6] text-sm">Your search history is empty.</p>
                <Link to="/catalog" className="text-[#8ab4f8] text-sm mt-2 hover:underline">Browse games</Link>
              </div>
            )}
          </div>
        </div>
