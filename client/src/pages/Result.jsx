...
import HardwareInput from "../components/HardwareInput"; // ✨ הייבוא של הקומפוננטה שלך ✨
...
export default function Result() {
  ...
  const handleTestSubmit = async () => {
    // מונע שליחה אם החומרה נמחקה (null) מהחיפוש
  ...
  return (
    <div className="flex flex-col items-center pt-16 sm:pt-24 px-4 min-h-screen pb-12 relative">
          ...
          {hardwareParts.map((part) => {
            ...
            return (
              ...
              >
                ...
                {/* ✨ עריכה Inline משודרגת עם HardwareInput ✨ */}
                {editingPart === part.id ? (
